...
DEFAULT_TEMPLATE = Path(__file__).with_name(
    "com.jacobmorris.agent-mesh-core.mcp-server.plist.template"
)
DEFAULT_OUTPUT = (
    Path.home() / "Library" / "LaunchAgents" / "com.jacobmorris.agent-mesh-core.mcp-server.plist"
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="render_mcp_launchd_plist.py")
